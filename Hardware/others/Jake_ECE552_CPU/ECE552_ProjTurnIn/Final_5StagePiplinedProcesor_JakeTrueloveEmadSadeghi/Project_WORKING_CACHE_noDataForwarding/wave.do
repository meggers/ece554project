...
add wave -noupdate -format Literal -radix hexadecimal /Full_processor_tb/instr
...
add wave -noupdate -format Literal /Full_processor_tb/FP1/data_mem/addr
add wave -noupdate -format Literal -expand /Full_processor_tb/FP1/data_mem/data_mem
